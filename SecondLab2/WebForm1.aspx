...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:RequiredFieldValidator ID="ValidatePassword" runat="server" ControlToValidate="InputPassword" ErrorMessage="Пароль не должен быть пустым"></asp:RequiredFieldValidator>
            ...
            <br />
            <asp:RequiredFieldValidator ID="ConfirmationPasswordRequired" runat="server" ControlToValidate="ConfirmationPassword" ErrorMessage="Пароль не должен быть пустым"></asp:RequiredFieldValidator>
            <br />
